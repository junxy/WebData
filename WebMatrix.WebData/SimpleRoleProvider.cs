...
namespace WebMatrix.WebData {
    ...
    using WebMatrix.WebData.Helpers;
    ...
    public class SimpleRoleProvider : RoleProvider {
        ...
        static internal string RoleTableName {
            get {
                return "webpages_Roles";
            }
        }

        static internal string UsersInRoleTableName {
            get {
        ...
        public override string[] FindUsersInRole(string roleName, string usernameToMatch) {
            ...
            using (var db = ConnectToDatabase()) {
                ...
                var userNames = db.Query(@"SELECT u." + SafeUserNameColumn + " FROM " + SafeUserTableName + " u, " + UsersInRoleTableName + " ur, " + RoleTableName + " r Where (r.RoleName = @0 and ur.RoleId = r.RoleId and ur.UserId = u." + SafeUserIdColumn + " and u." + SafeUserNameColumn + " LIKE @1)", new object[] { roleName, usernameToMatch });
                string[] users = new string[userNames.Count()];
                for (int i = 0; i < userNames.Count(); i++) {
                    users[i] = (string)userNames.Rows[i][0];
                }
                return users;
            }
        }
